...
#ifndef CONTROLLER_AGENT_NEW_H
#define CONTROLLER_AGENT_NEW_H
...
namespace controller {
    ...
    struct Agent {
        ...
        virtual void set_speed(double) = 0;  // TODO: added set speed need to modify other files
